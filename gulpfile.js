...
var app, base, concat, directory, gulp, gutil, hostname, path, refresh, sass, uglify, imagemin, minifyCSS, del, browserSync, autoprefixer, gulpSequence, shell, sourceMaps, plumber, copyright, header;
...
copyright     = require('./app/copyright.json');
header       = require('gulp-header');


var js_comment = [
    '/*!\n' +
    ' * Project: <%= copyright.project_name %>\n' +
    ' * Agency: <%= copyright.agency %>\n' +
    ' * @author <%= copyright.author %>\n' +
    ' * @email <%= copyright.email %>\n' +
    ' * @website <%= copyright.website %>\n' +
    ' * @version <%= copyright.js.version %>\n' +
    ' * \n' +
...
gulp.task('js', function() {
    ...
    return gulp.src(['app/js/src/_includes/**/*.js', 'app/js/src/**/*.js'])
                ...
                .pipe(header(js_comment, { copyright : copyright }))
...
gulp.task('css', function() {
    ...
    return gulp.src('app/css/scss/app.scss')
                ...
                //ADD Copyrights comment
                .pipe(header(css_comment, { copyright : copyright }))
